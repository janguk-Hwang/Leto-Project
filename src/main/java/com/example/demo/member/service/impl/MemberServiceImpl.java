...
public class MemberServiceImpl implements MemberService {
    ...
    public boolean sendResetPassword(ResetPasswordInput parameter) {
        ...
        String text = "<p> demo 비밀번호 초기화 메일입니다.</p> <p>아래 링크를 클릭하셔서 비밀번호를 초기화 해주세요.</p>" + "<div><a target='_blank' href='http://localhost:8080/member/reset/password?id=" + uuid + "'> 비밀번호 초기화하기 </a></div>";
        mailComponents.sendMail(email, subject, text);
    ...
    @Override
    public boolean favoritesURLSave(String url) {
